...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      '/api': {
        target: 'http://localhost:3001', // Si tu backend está en 3001
        changeOrigin: true,
        secure: false,
...
import {
  ...
  Typography,
  Button,
 Grid, // ⭐ USAR Grid2 para la nueva versión
  Card,
  CardContent,
  CardActions,
  Avatar,
  ...
  useEffect(() => {
    const loadCategories = async () => {
      try {
        ...
        setCategories([
          { id: 1, nombre: 'Limpieza Doméstica', descripcion: 'Servicio profesional de limpieza para tu hogar', icono: 'cleaning' },
          { id: 2, nombre: 'Plomería', descripcion: 'Reparaciones e instalaciones de plomería', icono: 'plumbing' },
          { id: 3, nombre: 'Electricidad', descripcion: 'Instalaciones y reparaciones eléctricas', icono: 'electrical' },
          { id: 4, nombre: 'Carpintería', descripcion: 'Trabajos en madera y muebles', icono: 'carpenter' },
          { id: 5, nombre: 'Jardinería', descripcion: 'Mantenimiento de jardines y áreas verdes', icono: 'garden' },
          { id: 6, nombre: 'Construcción', descripcion: 'Trabajos de construcción y remodelación', icono: 'build' },
        ]);
      }
    };
  ...
  const testimonials = [
    {
      ...
      service: 'Limpieza Doméstica',
    },
    {
      name: 'Carlos Martínez',
      rating: 5,
      comment: 'Resolvieron mi problema de plomería rápidamente.',
      service: 'Plomería',
    },
    {
      name: 'Ana Rodríguez',
      rating: 4,
      comment: 'Muy contentos con el trabajo de jardinería realizado.',
      service: 'Jardinería',
    },
  ];
  ...
  return (
    <Box>
      ...
      >
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            sx={{ mb: 4, opacity: 0.9 }}
          >
            Encuentra profesionales calificados para tu hogar o únete como trabajador independiente
          </Typography>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        {/* ⭐ GRID V2 SINTAXIS - SIN PROPS item, xs, sm, md */}
      ...
      >
        <Container maxWidth="md">
          ...
          <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
            Únete a miles de usuarios satisfechos en El Salvador
          </Typography>
          {!isAuthenticated && (
            <Button
              variant="contained"
...
const Navbar = () => {
  ...
  const authMenuItems = isAuthenticated
    ...
    : [
        { label: 'Iniciar Sesión', path: '/login', icon: null },
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormControl fullWidth margin="normal" error={!!errors.tipo}>
              ...
              <FormHelperText>
                {errors.tipo?.message || 
                 (watchTipo === 'cliente' ? 
                   'Podrás contratar servicios' : 
                   'Podrás ofrecer tus servicios')}
              </FormHelperText>
            </FormControl>

            {/* Resto del formulario igual... */}
            {/* [El resto del código del RegisterForm permanece igual] */}
...
## c:\Users\rexma\Desktop\chambing-website\src\components\auth\LoginForm.jsx
```
// src/components/auth/LoginForm.jsx - CORRECCIÓN
import React, { useState } from 'react';
              ...
              <Typography variant="body2">
                ...
                <Link 
                  ...
                  style={{ 
                    textDecoration: 'none',
                    fontWeight: 'bold',
                    color: '#2563eb'  // ⭐ CORREGIDO: Solo una propiedad color
                  }}
                >
                  Regístrate aquí
                </Link>
    ...
    const loadDashboardData = async () => {
      try {
        ...
        try {
          ...
          setCategories([
            { id: 1, nombre: 'Limpieza Doméstica', descripcion: 'Servicio de limpieza' },
            { id: 2, nombre: 'Plomería', descripcion: 'Reparaciones' },
            { id: 3, nombre: 'Electricidad', descripcion: 'Trabajos eléctricos' },
            { id: 4, nombre: 'Jardinería', descripcion: 'Mantenimiento' },
            { id: 5, nombre: 'Carpintería', descripcion: 'Trabajos en madera' },
            { id: 6, nombre: 'Construcción', descripcion: 'Obras' },
          ]);
        }
    ...
    <Box>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Alert severity="success" sx={{ mb: 3 }}>
          🎉 ¡Conexión exitosa con la API! Tu usuario está autenticado correctamente.
        </Alert>
            ...
            <Card sx={{ bgcolor: 'grey.50' }}>
              <CardContent>
                ...
                <Typography variant="body2" component="div">
                  ...
                  • Estado de carga: {loading ? 'Cargando...' : 'Completo'}<br/>
